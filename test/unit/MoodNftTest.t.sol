...
contract MoodNftTest is Test {
    ...
    function testViewTokenURI() public {
        // When you directly run this, it mint to the test contract, which doesn't have a receive function
        // OpenZeppelin bake in some code so that people wouldn't accidentally sends Nft to contracts that can't transfer them or do anything with them
        // We need to use VM.prank
        vm.prank(USER);
        moodNft.mintNft();
